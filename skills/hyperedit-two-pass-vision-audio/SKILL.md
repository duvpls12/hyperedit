...
### 3) Switch models
- Unload the two Qwen instances.
- Load audio LLM for semantic audio interpretation.

### 4) Audio pass
Use installed DSP stack (`librosa`, `essentia`) + audio LLM:
- BPM/tempo,
- beat/onset map,
- energy/loudness curve,
- spectral brightness,
- music/ambience/voice segmentation,
- sound-design event suggestions.
